...
@section('content')
    @include('admin.account-quality.header', ['header' => 'Email blacklist'])

    @alert()

    <div class="row">
        <div class="col-12">
            <p class="text-danger bg-light p-3">When an account is banned, the account will be deleted from our platform and added to blacklist, which
    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.account-quality.email-blacklist.search') }}" method="post">
                @csrf
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-auto my-1">
                        <a href="{{ route('admin.account-quality.email-blacklist.search') }}"
                ...
                @foreach($persons as $person)
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="{{ route('admin.account-quality.email-blacklist.ban', ['id' => $person->id]) }}"
    ...
    <div class="row">
        <div class="col-auto">
            ...
            @foreach ($limitRanges as $limit)
                <a href="{{ route('admin.account-quality.email-blacklist.search', array_merge(request()->query->all(), ['limit' => $limit])) }}"
