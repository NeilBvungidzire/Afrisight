...
@section('content')
    @include('admin.account-quality.header', ['header' => 'Mobile Number blacklist'])

    <div class="row">
        <div class="col-12">
            <h2 class="h5">
                Blacklist
{{--                <a class="btn btn-primary" href="{{ route('admin.account-quality.mobile-number-blacklist.search') }}">Search cases</a>--}}
            </h2>
    ...
    <div class="row">
        <div class="col-auto">
            ...
            @foreach ($limitRanges as $limit)
                <a href="{{ route('admin.account-quality.mobile-number-blacklist.index', array_merge(request()->query->all(), ['limit' => $limit])) }}"
