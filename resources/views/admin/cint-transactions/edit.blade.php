...
@section('content')
    @include('admin.reward-management.header', ['header' => 'Edit reward transactions'])

    <form action="{{ route('admin.cint.transactions.update', ['id' => $transaction->id]) }}" method="post" class="form">
        @csrf
        ...
        <div class="form-group row">
            <div class="col-sm-4 col-lg-3 offset-sm-4 offset-lg-6">
                <a href="{{ url()->previous() }}" class="btn btn-outline-info btn-block">Cancel</a>
            </div>
