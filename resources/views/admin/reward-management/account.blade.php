...
@section('content')
    @include('admin.reward-management.header', ['header' => 'Account'])

    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.reward_management.member-account.filter') }}" method="post">
                @csrf
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-auto my-1">
                        <a href="{{ route('admin.reward_management.member-account') }}" class="btn btn-outline-primary px-5">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                @foreach ($persons as $person)
                    <tr>
                        ...
                        <td class="text-nowrap">
                            ...
                            <a href="{{ route('admin.reward_management.member-account.params', ['id' => $person->id]) }}"
                               class="btn btn-sm btn-outline-info">
                                Account params
                            </a>
                        </td>
