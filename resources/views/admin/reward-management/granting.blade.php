...
@section('content')
    @include('admin.reward-management.header', ['header' => 'Rewarding'])

    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.reward_management.granting.filter') }}" method="post">
                @csrf
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-auto my-1">
                        <a href="{{ route('admin.reward_management.granting') }}" class="btn btn-outline-primary px-5">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                @foreach ($transactions as $transaction)
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="{{ route('admin.reward_management.granting.edit', ['id' => $transaction->id]) }}"
    ...
    <div class="row">
        <div class="col-auto">
            ...
            @foreach ($limitRanges as $limit)
                <a href="{{ route('admin.reward_management.granting', array_merge(request()->query->all(), ['limit' => $limit])) }}"
